  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {/* close buttton */}
        <button type="button" onClick={onClose} className="text-gray-400 bg-transparent hover:bg-gray-200 hover:bg-text-gray-900 rounded-lg text-sm w-8 h-8 inline-flex items-center justify-center">
